...
class BaseConfig:
    ...
    OHLCV_DB_CONNECTION_STRING: Optional[str] = os.getenv("OHLCV_DB_CONNECTION_STRING")
    AUTH_DB_CONNECTION_STRING: Optional[str] = os.getenv("AUTH_DB_CONNECTION_STRING")
    USER_CONFIGS_DB_CONNECTION_STRING: Optional[str] = os.getenv("USER_CONFIGS_DB_CONNECTION_STRING")
    REDIS_URL: Optional[str] = os.getenv("REDIS_URL", "redis://localhost:6379/0") # Added default
    ENCRYPTION_KEY_FERNET: Optional[str] = os.getenv("ENCRYPTION_KEY_FERNET")
    ...
    MAX_BACKFILL_CHUNKS_PER_RUN: int = int(os.getenv("APP_MAX_BACKFILL_CHUNKS_PER_RUN", "100"))
    DEFAULT_BACKFILL_PERIOD_MS: int = int(os.getenv("DEFAULT_BACKFILL_PERIOD_MS", str(315576000000))) # Approx 10 years
    ...
    POLLING_INTERVAL_ORDER_BOOK_SEC: int = int(os.getenv("APP_POLLING_INTERVAL_ORDER_BOOK_SEC", "2"))
    POLLING_INTERVAL_TRADES_SEC: int = int(os.getenv("APP_POLLING_INTERVAL_TRADES_SEC", "5")) # For ticker/recent trades
    POLLING_INTERVAL_OHLCV_SEC: int = int(os.getenv("APP_POLLING_INTERVAL_OHLCV_SEC", "60"))
    POLLING_INTERVAL_USER_ORDERS_SEC: int = int(os.getenv("APP_POLLING_INTERVAL_USER_ORDERS_SEC", "15"))
    ...
    def validate(cls):
        ...
        for var_name in ("SECRET_KEY", "OHLCV_DB_CONNECTION_STRING", "AUTH_DB_CONNECTION_STRING", "USER_CONFIGS_DB_CONNECTION_STRING", "REDIS_URL"):
...
class TestingConfig(BaseConfig):
    ...
    OHLCV_DB_CONNECTION_STRING: Optional[str] = os.getenv("TEST_OHLCV_DB_CONNECTION_STRING", BaseConfig.OHLCV_DB_CONNECTION_STRING)
